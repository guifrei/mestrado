\section{Implementação numérico-computacional}
...
Nas próximas subseções, serão apresentados os resultados obtidos a partir da aplicação das equações obtidas na seção \ref{secao_com_funcionais}
