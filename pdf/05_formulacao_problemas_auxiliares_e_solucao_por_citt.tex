...
\begin{figure}[H]
	\begin{center}
		...
		%\draw [ultra thick] (0, 2) -- (7, 2);
		%\draw [ultra thick] (8, 2) -- (10, 2);
		\draw [ultra thick, dashed] plot [smooth] coordinates {(0, 2) (1.5, 3.5) (2.5, 0.5) (3, 2)};
		\draw [ultra thick, dashed] plot [smooth] coordinates {(3.7, 2.3) (5, 3.5) (6.5, 1.5) (10, 2)};
		\draw [ultra thick] (0, 5) -- (10, 5);
		...
		\end{tikzpicture}
		\caption{Extensão do subdomínios $\Omega_1$ e $\Omega_2$ para as funções $F_{1, j}$ e $F_{2, j}$}
		\label{fig5}
	\end{center}
\end{figure}
...
Estas soluções são válidas para todo o domínio $0 \le y \le b$; as constantes $\mathbb{A}_{j,m}, \mathbb{B}_{j,m}, \mathbb{C}_{j,m}$ e $\mathbb{D}_{j,m}$, que particularizam estas soluções, serão determinadas através das condições de contorno sobre as fronteiras $\Gamma_0$ e $\Gamma_\infty$, e sobre a superfície de contato $\Gamma$\footnote{A expressão \eqref{solucao_temporaria_F1}, através da expansão dos argumentos das funções hiberbólicas, pode ser reescrita como:
