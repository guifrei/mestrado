...
%
& \frac{\mu_{m+1}}{\mu_m} \frac{y_{m+1}}{y_m} \frac{1 - e^{-2\mu_m b}}{1 - e^{-2\mu_{m+1} b}}\frac{2\mathbb{A}_{j,m+1}e^{-\mu_{m+1} b} - \bar{\psi}_{j, m+1}(1 + e^{-2\mu_{m+1} b})}{2\mathbb{A}_{j,m}e^{-\mu_m b} - \bar{\psi}_{j, m}(1 + e^{-2\mu_m b})} = \nonumber \\
\end{align}
