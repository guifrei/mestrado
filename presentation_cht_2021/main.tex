...
\begin{frame}
	\frametitle{Inverse problem}
		...
		\pause
		\draw (5, 0) node {\shadowbox{obtained from auxiliary problems}};			
		...
		\pause
		\draw (5, -5) node {\shadowbox{obtained from reciprocity functionals}};
...
%		\draw [-, red, very thick] (2.8, -2.6) -- (6.4, -2.6);
%		\draw [->, red, very thick] (6.4, -2.6) -- (6.4, -1.8);
		\draw (5.5, -2.8) node {\shadowbox{Gram-Schmidt orthogonalization}};
